...
# VLAN-related config.
if [ "$1" == "reboot" ]; then
	python config-vlan.py 1 10.0.1.2/24 10.0.1.102/24 reboot
	python config-vlan.py 3 10.0.3.2/24 10.0.3.102/24 reboot 
else
	python config-vlan.py 1 10.0.1.2/24 10.0.1.102/24
	python config-vlan.py 3 10.0.3.2/24 10.0.3.102/24
fi
