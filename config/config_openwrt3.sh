...
ovs-ofctl add-flow br-tun "table=21,priority=1,dl_vlan=1,actions=strip_vlan,set_tunnel:0x1,output:2,output:3"
ovs-ofctl add-flow br-tun "table=21,priority=1,dl_vlan=3,actions=strip_vlan,set_tunnel:0x3,output:2,output:3"
